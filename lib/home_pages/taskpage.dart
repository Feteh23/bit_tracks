          ...
          child: Padding(
            ...
            child: Column(
              children: [
                Row(
                  children: [
                    CircleAvatar( backgroundColor:  Color.fromARGB(255, 180, 86, 86),
child: Icon(Icons.notification_important, color: Colors.white)),
                ...
                Row(
                  children: [
                    ...
                    SizedBox(width: 15),
                    Text('Start: ${DateFormat('yyyy-MM-dd – HH:mm').format(task.startDate)}', style: TextStyle(fontSize: 19)),
                ...
                Row(
                  children: [
                    ...
                    SizedBox(width: 15),
                    Text('Due: ${DateFormat('yyyy-MM-dd – HH:mm').format(task.dueDate)}', style: TextStyle(fontSize: 19)),
                  ],
                ),
                SizedBox(height: 15),
                Row(
                  children: [
                    ...
                    SizedBox(width: 15),
                    Expanded(
                      child: Text(task.description, style: TextStyle(fontSize: 19)),
                    ),
                  ],
                ),
                SizedBox(height: 30),
